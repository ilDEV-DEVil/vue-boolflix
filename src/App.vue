   ...
   <ul>
     ...
     <li v-for="card in filmList" :key="card.id">
       ...
       <!-- STELLE PIENE -->
        ...
        <!-- STELLE VUOTE-->
        <i v-for="star,i in 5" :key="i + 5" class="fa fa-star-o " :class=" Math.ceil(card.vote_average / 2) > i ? 'd-none' : ''"  aria-hidden="true"></i>
  ...
  <!-- SERIE TV -->
    <ul>
      ...
      <li v-for="card in tvShowList" :key="card.id">
        ...
        <!-- STELLE VUOTE-->
        <i v-for="star,i in 5" :key="i + 15" class="fa fa-star-o " :class=" Math.ceil(card.vote_average / 2) > i ? 'd-none' : ''"  aria-hidden="true"></i>
